...
-   单行写入操作
    ...
    -   PutRow：本次消耗的写 CU 为修改的行主键数据大小与属性列数据大小之和除以 4 KB 向上取整。若指定条件检查不为 IGNORE，还需消耗该行主键数据大小除以 4 KB 向上取整的读 CU。如果操作不满足应用程序指定的行存在性检查条件，则操作失败并消耗 1 单位写服务能力单元和 1 单位读服务能力单元。请参见 [PutRow](../../../../intl.zh-CN/API 参考/API 概览/PutRow.md#)详解。

    -   UpdateRow：本次消耗的写 CU 为修改的行主键数据大小与属性列数据大小之和除以 4 KB 向上取整。UpdateRow 中包含的需要删除的属性列，只有其列名计入该属性列数据大小。若指定条件检查不为 IGNORE，还需消耗该行主键数据大小除以 4 KB 向上取整的读 CU。如果操作不满足应用程序指定的行存在性检查条件，则操作失败并消耗 1 单位写服务能力单元和 1 单位读服务能力单元。请参见 [UpdateRow](../../../../intl.zh-CN/API 参考/API 概览/UpdateRow.md#) 详解。

    -   DeleteRow：被删除的行主键数据大小除以 4 KB 向上取整。若指定条件检查不为 IGNORE，还需消耗该行主键数据大小除以 4 KB 向上取整的读 CU。如果操作不满足应用程序指定的行存在性检查条件，则操作失败并消耗 1 单位写服务能力单元。请参见 [DeleteRow](../../../../intl.zh-CN/API 参考/API 概览/DeleteRow.md#) 详解。
    ...
    更多信息请参见 API Reference 中的 [PutRow](../../../../intl.zh-CN/API 参考/API 概览/PutRow.md#)、[UpdateRow](../../../../intl.zh-CN/API 参考/API 概览/UpdateRow.md#) 和 [DeleteRow](../../../../intl.zh-CN/API 参考/API 概览/DeleteRow.md#) 章节。
...
-   单行读取操作
    ...
    更多信息请参见 API Reference 的 [GetRow](../../../../intl.zh-CN/API 参考/API 概览/GetRow.md#) 章节。
...
更多信息请参见 API Reference 中的 [BatchWriteRow](../../../../intl.zh-CN/API 参考/API 概览/BatchWriteRow.md#)与 [BatchGetRow](../../../../intl.zh-CN/API 参考/API 概览/BatchGetRow.md#) 章节。
...
更多详细信息请参见 API Reference 中的 [GetRange](../../../../intl.zh-CN/API 参考/API 概览/GetRange.md#) 章节。

## 最佳实践 { .section}

 [表格存储数据操作的最佳实践](../../../../intl.zh-CN/最佳实践/数据操作篇.md#) 

## 使用表格存储 SDK 进行数据操作 { .section}

 [使用 TableStore Java SDK 进行数据操作](../../../../intl.zh-CN/SDK 参考/Java SDK/前言.md#) 

 [使用 TableStore Python SDK 进行数据操作](../../../../intl.zh-CN/SDK 参考/Python SDK/简介.md#) 
