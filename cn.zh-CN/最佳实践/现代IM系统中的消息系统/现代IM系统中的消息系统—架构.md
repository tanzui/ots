# 现代IM系统中的消息系统—架构 {#concept_1732548 .concept}
...
## 背景 {#section_yzp_it1_ug8 .section}

在这个高度信息化的移动互联网时代，IM（Instant Messaging，即时通讯）类产品已经成为生活必备品，例如钉钉、微信、QQ。微信已经成长为一个生态型产品，但其核心功能仍是IM。此外，还有一些非以IM系统为核心的应用也经常出现在我们的娱乐社交生活，例如在线游戏、社交应用。IM系统已经是任何一个带有社交属性的应用需要具备的基础功能。
...
## 传统架构 vs 现代架构 {#section_5oa_h6i_0hh .section}

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1372235/156635863256000_zh-CN.png)
...
## Timeline模型 {#section_1jo_xoy_c6w .section}
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1372235/156635863256001_zh-CN.png)
...
## 消息存储模型 {#section_3iy_gu2_6i1 .section}

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1372235/156635863256005_zh-CN.png)
...
## 消息同步模型 {#section_ugw_934_zuq .section}

消息同步模型会比消息存储模型稍复杂一些，消息的同步一般有读扩散（也叫拉模式）和写扩散（也叫推模式）两种不同的方式，分别对应不同的Timeline物理模型。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1372235/156635863356006_zh-CN.png)
...
## 典型架构设计 {#section_oyw_0q8_rjh .section}

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1372235/156635863356007_zh-CN.png)
...
## 专家服务 {#section_hvm_hpp_nuf .section}

表格存储 提供专业的免费的技术咨询服务，欢迎加入我们的钉钉讨论群。

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1135425/156635863353785_zh-CN.png)
