...
-   在Maven项目中加入依赖项
    ...
    在Maven工程中使用Table Store Java SDK，只需在pom.xml中加入相应依赖即可。以 4.10.2 版本为例，在 <dependencies\> 内加入如下内容：
...
-   Eclipse中导入JAR包
    ...
    1.  [下载Java SDK开发包](http://docs-aliyun.cn-hangzhou.oss.aliyun-inc.com/assets/attach/108096/cn_zh/1552274752739/tablestore-4.10.2-release.zip)
    2.  解压该开发包。
